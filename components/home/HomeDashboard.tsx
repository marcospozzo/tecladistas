            ...
            <div className="space-y-5">
              <div className="space-y-4">
                <h1 className="max-w-3xl text-4xl font-semibold tracking-tight sm:text-5xl">
                  ...
                  : instrumentos, técnicos, estudios, fotos, partituras y
                  clases.
                </h1>
                <p className="max-w-2xl text-base leading-7 text-slate-600 dark:text-slate-300 sm:text-lg">
                  Esta web reúne información y recursos en torno al universo de
                  Tecladistas Gitanxs. Por motivos de privacidad y seguridad, la
                  página es de uso exclusivo para miembros del grupo. A
                  excepción de la sección de clases, que es de público acceso.
                </p>
              </div>
            </div>
          </div>
